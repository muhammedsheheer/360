...
const TimeForm: FC<TimeFormProps> = ({ mainform, setpage }) => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-3">
      <p className="text-3xl font-semibold text-[#fff]">Book A Table</p>
      ...
      <Form {...form}>
        ...
        >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger className="h-12 border-muted bg-transparent text-[#fff] placeholder:text-[#fff]">
                  ...
                  <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
                    <PopoverTrigger asChild>
                      <FormControl>
                        <Button
                          variant={"outline"}
                          className={`h-12 w-full justify-start border-muted bg-transparent text-left font-normal text-[#fff]`}
                        >
          ...
          <Button
            className="mt-4 w-fit bg-[#D3A641] px-6 py-6 font-semibold text-[#000]"
            disabled={disable}
          >
            Book A Table
          </Button>
