  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-3">
      ...
      <p className="max-w-[700px] text-center">
        Please note : All online bookings should be sent 24 hours before arrival
        time . If you have any special requests for your visit please provide
      ...
      <p className="max-w-[700px] text-center">
        Booking Notice : we will not be accepting bookings in Ramadan, walk-ins
        only. thank you.
      </p>
      <Form {...form}>
        <form
        ...
        >
          <div className="grid w-full max-w-[700px] grid-cols-1 gap-6 border-b-[2px] border-b-gray-900 py-12 md:grid-cols-2">
            <FormField
          ...
          <Button className="w-fit px-6 py-6 font-semibold" disabled={disable}>
            Book A Table
          </Button>
        </form>
      </Form>
