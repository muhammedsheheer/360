...
const CustomerDetails: FC<CustomerDetailsProps> = ({
  ...
  return (
    <div className="flex w-full flex-col items-end gap-5">
      ...
      <div className="flex w-full flex-col gap-3 bg-[#D3A641] px-12 py-6">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <div className="flex w-full items-center md:justify-center">
            <p
              className="w-fit cursor-pointer border-b-[1px] border-b-muted text-[#fff]"
              onClick={() => setpage(0)}
            >
              Change Selection
            </p>
        ...
        render={({ field }) => (
          <FormItem className="w-full">
            ...
            <FormControl>
              <Textarea
                {...field}
                className="min-h-[100px] border-muted bg-transparent text-[#fff]"
      ...
      <div className="flex w-full justify-center">
        <Button
          type="submit"
          className="w-fit bg-[#D3A641] px-6 py-6 font-semibold text-black md:float-right md:w-fit"
